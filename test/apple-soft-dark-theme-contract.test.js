...
assert.match(source, /--soft-page:\s*#1d1e22/);
assert.match(source, /--soft-panel:\s*#25262a/);
assert.match(source, /--soft-text:\s*#999eaa/);
assert.match(source, /--soft-muted:\s*#999eaa/);
